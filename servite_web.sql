...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-12-2021 a las 00:08:43
...
DROP TABLE IF EXISTS `categorias_videojuegos`;
...
DROP TABLE IF EXISTS `imagenes_presentacion`;
...
DROP TABLE IF EXISTS `play_juego`;
...
DROP TABLE IF EXISTS `tipos_fotos`;
